...
export class HistorialComponent implements OnInit {
    ...
    ServiceColumn: string[] = ['start_date','end_date','type', 'client', 'worker','user','address','action'];
    ...
    viewDetailService(id: any) {
        console.log('detalles del servicio:'+id);
    ...
    applyFilter($event: KeyboardEvent) {
        ...
        this.listService.filter = filterValue.trim().toLowerCase();
        console.log(this.listService.filter);
    }

    filterStatus(value) {
        if(value==undefined) value='';
        this.listService.filter = value.trim().toLowerCase();
        console.log(this.listService.filter);
    }
    filterType(value) {
        if(value==undefined) value='';

...
export declare class StarRatingControlComponent extends StarRating implements ControlValueAccessor {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<StarRatingControlComponent>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<StarRatingControlComponent, "star-rating-control", never, {

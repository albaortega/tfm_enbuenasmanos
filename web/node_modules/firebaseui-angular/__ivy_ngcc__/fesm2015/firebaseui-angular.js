...
FirebaseuiAngularLibraryService.ɵfac = function FirebaseuiAngularLibraryService_Factory(t) { return new (t || FirebaseuiAngularLibraryService)(ɵngcc0.ɵɵinject(ɵngcc1.AngularFireAuth)); };
...
FirebaseuiAngularLibraryService = __decorate([ __metadata("design:paramtypes", [AngularFireAuth])
...
FirebaseuiAngularLibraryComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: FirebaseuiAngularLibraryComponent, selectors: [["firebase-ui"]], outputs: { signInSuccessWithAuthResultCallback: "signInSuccessWithAuthResult", signInFailureCallback: "signInFailure" }, decls: 1, vars: 0, consts: [["id", "firebaseui-auth-container"]], template: function FirebaseuiAngularLibraryComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(FirebaseuiAngularLibraryService, [{
        type: Injectable
    }], function () { return [{ type: ɵngcc1.AngularFireAuth }]; }, null); })();
